...
{
    public class CoinPool : BaseItemPool<CoinItem>
    {
        private const int PoolSize = 5;

        public CoinPool(IObjectGetterService objectGetterService, GameObjectFactory gameObjectFactory, ManagerOfSystems managerOfSystems) : 
            base(objectGetterService, gameObjectFactory, managerOfSystems, PrefabNames.CoinPrefab, PoolSize)
        {
        }
