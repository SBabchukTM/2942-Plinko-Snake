...
{
    public class MagnetsPool : BaseItemPool<Magnet>
    {
        private const int PoolSize = 5;

        public MagnetsPool(IObjectGetterService objectGetterService, GameObjectFactory gameObjectFactory, ManagerOfSystems managerOfSystems) : 
            base(objectGetterService, gameObjectFactory, managerOfSystems, PrefabNames.MagnetPrefab, PoolSize)
        {
        }
