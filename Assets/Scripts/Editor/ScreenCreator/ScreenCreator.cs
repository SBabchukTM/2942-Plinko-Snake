...
public class ScreenCreator : EditorWindow
{
    ...
    private void CreateNewPrefab(string name)
    {
        ...
        Type classType = FindTypeInAssemblies($"Runtime.Game.UI.Screen.{name}");
    ...
    public void RegisterInUIServiceViewContainer(GameObject prefabAsset)
    {
        ...
        screensPrefabProperty.GetArrayElementAtIndex(screensPrefabProperty.arraySize - 1).objectReferenceValue = baseWindowComponent;
